...
let userSelection = {
    sprite: "chocopie", // Example sprite
...
k.loadSprite("nutella", "sprites/nutella.png");
k.loadSprite("chocopie", "sprites/chocopie.png");
k.loadSprite("cookie", "sprites/cookie.png");
k.loadSprite("cheesecake", "sprites/cheesecake.png");
k.loadSprite("cupcake", "sprites/cupcake.png");
k.loadSprite("icecream", "sprites/icecream.png");
...
k.scene("gridgame", () => {
	// debug.log(JSON.stringify(userSelection))
    generateGrid();
...
k.scene("selector", () => {
	...
	function updateCharacterSprite() {
		...
		userSelection.sprite = shapes[currentShapeIndex];
		userSelection.color = currentColorKey;
    }
    ...
    function updateSelectionDisplay() {
		...
		// userSelection.color = colors[currentColorIndex]
